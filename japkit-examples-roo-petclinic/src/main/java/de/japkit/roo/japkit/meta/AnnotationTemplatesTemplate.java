...
import de.japkit.roo.japkit.meta.AnnotationTemplatesTemplate.AnnotationName_.AnnotationTemplateAVMembers;

@RuntimeMetadata
@Clazz()
public class AnnotationTemplatesTemplate {
	@InnerClass(src = "#{triggerAnnotation.targetAnnotations}",
